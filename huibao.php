...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body>		
		...
		<span id="control2" style="display:none; color:red; ">请手动复制以下日报，然后发微信给小戒就可以。每日支持小戒的工作，去点一下养生微信文章底部的广告就可以，<a href="http://mp.weixin.qq.com/mp/getmasssendmsg?__biz=MjM5ODMyMTI2MA==#wechat_webview_type=1&wechat_redirect">去点广告</a></span>
		<div id="out">
	...
	seajs.use(['$','http://style.aliexpress.com/js/6v/lib/gallery/store/store.js'], function($,store) {
		...
		$('#control').click(function(){ 
			...
			$("#out").append("<div class='score'>你今日的养生成绩为："+score+" 分</div>");
