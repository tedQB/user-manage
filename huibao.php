...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<script type="text/javascript" src="http://style.c.aliimg.com/app/community/js/hudong/module/ZeroClipboard.js"></script>	
	<style type="text/css">
	...
	<body>		
		...
		<div>
		  <div class="input-group">
			...
			<input type="text" class="form-control" id="" placeholder="请如实回答并填写自评" style="width:100%" />
		  </div>
		   <div class="radio-group">
			...
			<label>
			  <input type="radio" name="one-radio" value="1">【差1分】接触5分钟以上 
			 </label>		   		   
		   </div>		  
		</div>
		<div>
		  <div class="input-group">
			...
			<input type="text" class="form-control" id="" placeholder="请如实回答并填写自评" />
		   ...
		   <div class="radio-group">
			...
			<label>
			  <input type="radio" name="two-radio" value="1">【差1分】意淫5分钟以上 
			 </label>		   		   
		   </div>		  
		</div>
		<div>
		  <div class="input-group">
		   ...
		   <div class="radio-group">
			...
			<label>
			 ...
			 <label>
			<input type="radio" name="three-radio" value="-5">【极差-5分】我破戒了 一点没有总结，也没有遵守2倍法则
			 </lable>
		   </div>			  
		 </div>		
		<div>
		  <div class="input-group">
		   ...
		   <div class="radio-group">
			...
			<label>
			  <input type="radio" name="four-radio" value="1">【差1分】风平浪静，逍遥自在 
			 </label>		   		   
		   </div>			  
		 </div>		
		<div>
		  <div class="input-group">
		   ...
		   <div class="radio-group">
			...
			<label>
			  <input type="radio" name="five-radio" value="1">【差1分】我什么都没有做
			 </label>		   		   
		   </div>			  
		 </div>				
		<div>
		  <div class="input-group">
		   ...
		   <div class="radio-group">
			...
			<label>
			  <input type="radio" name="six-radio" value="3">【差3分】我什么都没有做，或者我心里知道懒得写
			 </label>		   		   
		   </div>			  
		</div>
		<div>
		  <div class="input-group">
			...
			<input type="text" class="form-control" id="" placeholder="一切能够推动社会进步,为社会做贡献，为集体做贡献，能够照亮人心，让别人主动感恩的的事情都叫正能量" />
		  </div>				
		   <div class="radio-group">
			<label>
			...
			<label>
			  <input type="radio" name="theve-radio" value="3">【差3分】我什么都没有做
			 </label>		   		   
		   </div>			  
		...
		<span id="control2" style="display:none; color:red; ">请手动复制以下日报，然后发微信给小戒就可以。每日支持小戒的工作，去点一下戒色微信文章底部的广告就可以，<a href="http://mp.weixin.qq.com/mp/getmasssendmsg?__biz=MjM5ODMyMTI2MA==#wechat_webview_type=1&wechat_redirect">去点广告</a></span>
		<div id="out">
	...
	seajs.use(['$','http://style.aliexpress.com/js/6v/lib/gallery/store/store.js'], function($,store) {
		...
		$('#control').click(function(){ 
			...
			if(score==0||score<0){ 
				...
				tip="评估结果：加油吧，还差一点就到及格线了，请努力改进自己的状态，每天按照日报的内容执行，明天请加油";
			}	
			...
			$("#out").append("<div class='score'>你今日的戒色成绩为："+score+" 分</div>");
